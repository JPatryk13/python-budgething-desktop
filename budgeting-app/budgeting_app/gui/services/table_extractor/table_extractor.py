...
from budgeting_app.gui.services.table_extractor.image_tools import TableObjF, TableObjData, Tools
...
class TableExtractor(MainWindow):
    ...
    def __init__(self, parent: Any | None = None):
        ...
        self._create_table_settings_widgets()
    ...
    def set_table_detector_workspace(self, pdf_file_wrapper: PDFFileWrapper) -> None:
        ...
        self.image_viewer.set_image(self.table_detector_workspace.set_pdf_file_image().pdf_file.image.image_bytes)
    ...
    def __table_drawing_tool_button_clicked(self) -> None:
        ...
        self.image_viewer.set_tool(Tools.TABLE_DRAWING_TOOL)
    ...
    def __hand_tool_button_clicked(self) -> None:
        ...
        self.image_viewer.set_tool(Tools.HAND_TOOL)

    def __column_count_changed(self) -> None:
        self.image_viewer.set_col_count(self.column_count_spinbox.value())

    def __row_count_changed(self) -> None:
        self.image_viewer.set_row_count(self.row_count_spinbox.value())
    ...
    def _create_table_settings_widgets(self) -> None:
    ...
    def __new_table(self, page_index: int, table_obj: TableObjF) -> None:
    ...
    def __table_updated(self, page_index: int, table_index: int, table_obj: TableObjF) -> None:
        # Remove old table
